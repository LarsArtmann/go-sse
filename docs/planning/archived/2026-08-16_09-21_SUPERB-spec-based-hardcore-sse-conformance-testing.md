...
**Status:** DONE (2026-08-16) — execution report: [docs/status/2026-08-16_10-14_sse-spec-conformance-execution.md](2026-08-16_10-14_sse-spec-conformance-execution.md — same directory)
...
- Existing green tests stay green except those that pinned _spec-incorrect_ behavior (F11) — each flip is justified by a spec citation in the test comment.
