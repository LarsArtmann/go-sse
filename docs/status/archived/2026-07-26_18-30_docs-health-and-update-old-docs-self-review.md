...
- Fully read 2026-08-29 (252/252). Section A verified intact. Section B/C/D items all closed by later work: DOMAIN_LANGUAGE line refs replaced with maintenance-free symbol-only refs (2026-08-03 09-25 sweep); hardcoded coverage replaced by measured-and-refreshed figures (98.9%/95.3% as of this pass); gopls json.Marshal warning investigated and documented as the GOEXPERIMENT=jsonv2 false positive (2026-08-03 00-51); flake check green (2026-08-29); time.Sleep/integration/coverage items shipped v0.2.1; CHANGELOG completeness audited in every later release cut. Section F 1-27 done or superseded; 28-50 -> ecosystem/Won't-until-asked (CODEOWNERS/dependabot/SECURITY.md repeatedly evaluated and deferred). Section G 1 answered (false positive, documented); G2 resolved (09-25 rewrite); G3 superseded (v0.2.1 shipped 2026-07-26). Fully resolved -> archived.
