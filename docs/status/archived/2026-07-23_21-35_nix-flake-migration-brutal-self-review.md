...
- Fully read 2026-08-29 (177/177). Resolution appendix (2026-07-26) verified. Section C 1 (vendorHash note) done 2026-08-29 - AGENTS.md gotcha added (recompute flow + independent hashes). Section C 2 (README nix mention) Won't implement - README stays end-user-facing; CONTRIBUTING owns dev workflow. Section C 3 done (CI exists; hermetic-gate-in-CI remains open as TODO_LIST CI item). Section C 4 done (.envrc exists, buildflow-managed, AGENTS.md documents it). Section C 5 Won't (golines defaults kept). Section C 6 Won't (cosmetic). Section F 1 done; 2 Won't; 3 done; 4-5, 7-13 Won't-until-asked or superseded; 6 done (verified via clean-cache runs 2026-08-29); 14-19 ecosystem items -> sibling repos; 20-27 done/superseded (drop policy in README, fuzz tests, coverage gate, integration tests, OnDisconnect race-tested); 28-32 done (CI, coverage, examples, CHANGELOG, tags); 33-40 Won't-until-asked (--all-systems open as TODO_LIST item); 41-45 skill feedback -> skill repo; 46-50 verification items done or Won't (coverage app runs; flake check green 2026-08-29). Fully resolved -> archived.
